        ...
        <div className="row px-xl-5">
            <div className="col-12">
                <nav className="breadcrumb bg-light mb-30">
                    ...
                    <NavLink className="breadcrumb-item text-dark" to="#">Shop</NavLink>
            ...
            <div className="col-lg-4">
                ...
                <div className="mb-5">
                    ...
                    <div className="bg-light p-30">
                        ...
                        <div className="form-group">
                            <div className="custom-control custom-radio">
                                <input type="radio" className="custom-control-input" name="payment" id="googlepay"/>
                                <label className="custom-control-label" htmlFor="googlepay">Google Pay</label>
                            </div>
                        </div>
                        <div className="form-group">
                            <div className="custom-control custom-radio">
                                <input type="radio" className="custom-control-input" name="payment" id="phonepay"/>
                                <label className="custom-control-label" htmlFor="phonepay">Phone Pay</label>
                            </div>
                        </div>
                        <div className="form-group">
                            <div className="custom-control custom-radio">
                                <input type="radio" className="custom-control-input" name="payment" id="paytm"/>
                                <label className="custom-control-label" htmlFor="paytm">PayTm</label>
                            </div>
                        </div>
